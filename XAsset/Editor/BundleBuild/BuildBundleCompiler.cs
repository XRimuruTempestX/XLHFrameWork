...
namespace XAsset.Editor.BundleBuild
{
    ...
    public class BuildBundleCompiler
    {
        ...
        /// 打包模块类型
        /// </summary>
        private static string mBundleModuleName;
        ...
        private static string mBundleOutPutPath
        {
            get
            {
                return Application.dataPath + "/../AssetBundle/" + mBundleModuleName + "/" +
        ...
        private static string mHotAssetsOutPutPath
        {
            get
            {
                return Application.dataPath + "/../HotAssets/" + mBundleModuleName + "/" + mHotAppVersion + "/" +
            ...
            int hotPatchVersion = 0, string hotAppVersion = "0.0.0", string updateNotice = "")
        {
            ...
            mBundleModuleName = moduleData.moduleName;
        ...
        public static void GenerateBundleBuilder(bool clear = false)
        {
            ...
            //收集至Bundle打包配置文件
            string bundleConfigPath = BundleSettings.Instance.XAssetRootPath + "/Config/" + mBundleModuleName.ToLower() + "assetbundleconfig.json";
            mBundleBuildList.Add(new AssetBundleBuild(){ assetBundleName = mBundleModuleName.ToLower() + "bundleconfig"+BundleSettings.Instance.ABSUFFIX,assetNames = new []
            {
        ...
        private static void WriteAssetBundleConfig()
        {
            ...
            foreach (var item in allBundleFilePathDic)
            {
                ...
                if (!filePath.EndsWith(".cs"))
                {
                    ...
                    info.bundleModule = mBundleModuleName;
        ...
        /// 生成热更模块配置到Resources文件夹
        /// </summary>
        private static void GeneratorHotModuleCfgToResource()
        {
            ...
            if (textAsset==null)
            {
                ...
                bundleModuleCfgJson = JsonConvert.SerializeObject(bundleModuleData,  Formatting.Indented);
        ...
        public static void GeneratorHotAssetsManifest()
        {
            ...
            assetsManifest.downLoadURL = BundleSettings.Instance.AssetBundleDownLoadUrl+"/HotAssets/"+mBundleModuleName+"/"+ 
            ...
            string hotMainifestPath = Application.dataPath + "/../HotAssets/" + mBundleModuleName +"/"+ BundleSettings.Instance.HotManifestName(mBundleModuleName);
            //生成热更清单，用来对比MD5和文件下载
            FileHelper.WriteFile(hotMainifestPath, System.Text.Encoding.UTF8.GetBytes(json));
            //备份热更清单，用来版本回退
            File.Copy(hotMainifestPath,mHotAssetsOutPutPath+BundleSettings.Instance.HotManifestName(mBundleModuleName));
        }
        ...
        {
            return mBundleModuleName + "_" + abName;
        }
        ...
        public static void CopyBundleToStramingAssets(BundleModuleData moduleData,bool showTips=true)
        {
            ...
            FileInfo[] fileInfoArr = directoryInfo.GetFiles("*", SearchOption.AllDirectories);
            //Bundle内嵌的目标文件夹
            string streamingAssetsPath = Application.streamingAssetsPath + "/AssetBundle/" + mBundleModuleName + "/";
            ...
            FileHelper.WriteFile(mResourcesPath+mBundleModuleName+"info.json",System.Text.Encoding.UTF8.GetBytes(json));
