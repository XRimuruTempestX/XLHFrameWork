...
namespace XAsset.Runtime.BundleHot
{
    public class HotAssetsManager : IHotAssets
    {
        public class DownLoadModule
        {
            ...
            public Action<string> starHot;
            public Action<string> waiteDownloadCallBack;
        ...
        /// 所有热更模块
        /// </summary>
        private Dictionary<string, DownLoadModule> mAllAssetsModuledic =
            new Dictionary<string, DownLoadModule>();

        /// <summary>
        /// 正在下载热更资源模块字典
        /// </summary>
        private Dictionary<string, DownLoadModule> mDownLoadingAssetsModuleDic =
            new Dictionary<string, DownLoadModule>();

        /// <summary>
        /// 正在下载的令牌
        /// </summary>
        private Dictionary<string, CancellationTokenSource> mAllDownLoadAssetsModuleTokenSourceDic =
        ...
        /// 所有模块各自的下载进度
        /// </summary>
        public static Dictionary<string, ModuleDownProgress>  mAllDownLoadAssetsModuleProgress =  new Dictionary<string, ModuleDownProgress>();
        ...
        public async UniTask<(bool, float)> CheckAssetsVersion(string bundleModule)
        {
        ...
        private DownLoadModule GetHotAssetsModule(string bundleModule)
        {
        ...
        private DownLoadModule GetOrNewHotAssetsModule(string bundleModule,
            Action<string> startHotCallBack, Action<string> waiteDownloadCallBack,
            Action<HotFileInfo> onDownLoadSuccess, Action<HotFileInfo> onDownLoadFailed,
            Action<HotAssetsModule> onDownLoadFinish, bool isCheckAssetsVersion = true)
        {
        ...
        public static string GetDownLoadProgress( string modules)
        {
            float curDownSize = 0;
            float totalSize = 0;
        ...
        /// </summary>
        /// <param name="bundleModule"></param>
        public static void RemoveDownLoadProgress(string bundleModule)
        {
