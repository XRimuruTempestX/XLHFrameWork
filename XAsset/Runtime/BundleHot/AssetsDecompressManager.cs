...
namespace XAsset.Runtime.BundleHot
{
    public class AssetsDecompressManager : IDecompressAssets
    {
        ...
        /// <returns></returns>
        public override IDecompressAssets StartDeCompressBuiltinFile(string bundleModule, Action callBack)
        {
            if (ComputeDecompressFile(bundleModule))
            {
                IsStartDecompress = true;
                MonoMgr.Instance.StartCoroutine(UnPackToPersistentDataPath(bundleModule, callBack));
            }
            else
            {
                Debug.Log("不需要解压文件");
        ...
        /// <returns></returns>
        private bool ComputeDecompressFile(string bundleModule)
        {
        ...
        /// <returns></returns>
        IEnumerator UnPackToPersistentDataPath(string bundleModule, Action callBack)
        {
