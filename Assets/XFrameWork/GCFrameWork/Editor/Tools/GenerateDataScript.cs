...
{
    public class GenerateDataScript : OdinEditorWindow
    {
        [TextArea(4, 50)]
        ...
        [MenuItem("GameObject/GC框架/生成数据层脚本",false,0)]
        public static void Generate()
        {
            GenerateDataScript  window = GetWindow<GenerateDataScript>();
        ...
        public void GenerateButton()
        {
            ...
            string filePath = scriptPath + "/" + selectObject.name + "Data.cs";
        ...
        private void GenerateScript()
        {
            ...
            if (worldEnum != WorldEnum.Null)
            {
                ...
                sb.AppendLine($"\tpublic class {selectObject.name}Data : IDataBehaviour");
                sb.AppendLine("\t{");
