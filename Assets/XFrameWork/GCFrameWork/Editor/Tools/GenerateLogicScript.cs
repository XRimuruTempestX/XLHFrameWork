...
{
    public class GenerateLogicScript : OdinEditorWindow
    {
        [TextArea(4, 50)]
        ...
        [MenuItem("GameObject/GC框架/生成逻辑层脚本",false,0)]
        public static void Generate()
        {
            GenerateLogicScript  window = GetWindow<GenerateLogicScript>();
        ...
        public void GenerateButton()
        {
            ...
            string filePath = scriptPath + "/" + selectObject.name + "Logic.cs";
        ...
        private void GenerateScript()
        {
            ...
            if (worldEnum != WorldEnum.Null)
            {
                ...
                sb.AppendLine($"\tpublic class {selectObject.name}Logic : ILogicBehaviour");
                sb.AppendLine("\t{");
