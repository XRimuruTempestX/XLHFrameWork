...
namespace XLHFramework.GCFrameWorlk.Editor
{
    ...
    public class WorldConfig : ScriptableObject
    {
        ...
        public void GenerateWorldEnumScript()
        {
            ...
            if (!Directory.Exists(generateSpriptPath))
            {
                Directory.CreateDirectory(generateSpriptPath);
            }
            
            if (!Directory.Exists(generateExctionPath))
            {
                Directory.CreateDirectory(generateExctionPath);
            }
