...
namespace XAsset.Runtime.BundleHot
{
    public class HotAssetsModule
    {
        ...
        /// 当前下载的资源模块类型
        /// </summary>
        public string CurBundleModuleEnum { get; set; }
        ...
        public HotAssetsModule(string bundleModule, Action<HotFileInfo> onDownLoadSuccess,
        ...
        public void StartDownLoadHotAssets(Action<string> startDonwLoadCallBack)
        {
