...
{
    public class GenerateMsgScript : OdinEditorWindow
    {
        [TextArea(4, 50)]
        ...
        [MenuItem("GameObject/GC框架/生成网络层脚本",false,0)]
        public static void Generate()
        {
            GenerateMsgScript  window = GetWindow<GenerateMsgScript>();
        ...
        public void GenerateButton()
        {
            ...
            string filePath = scriptPath + "/" + selectObject.name + "Message.cs";
        ...
        private void GenerateScript()
        {
            ...
            if (worldEnum != WorldEnum.Null)
            {
                ...
                sb.AppendLine($"\tpublic class {selectObject.name}Message : IMsgBehaviour");
                sb.AppendLine("\t{");
