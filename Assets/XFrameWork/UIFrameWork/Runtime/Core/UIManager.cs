...
namespace XLHFramework.UIFrameWork.Runtime.Core
{
    public class UIManager
    {
        ...
        {
            uiCameraGameObject = GameObject.Instantiate(Resources.Load<GameObject>("UICamera"));
            uiCamera = uiCameraGameObject.GetComponent<Camera>();
            GameObject.DontDestroyOnLoad(uiCameraGameObject);

            eventSystemGameObject = GameObject.Instantiate(Resources.Load<GameObject>("EventSystem"));
        ...
        */
        ...
        {
            GameObject obj = null;
            var objAsset = await ResourceSystem.Instance.LoadAssetAsync<GameObject>(windowName);
            obj = GameObject.Instantiate(objAsset);
            obj.name = windowName;
            return obj;
        }
        ...
        private void GameObjectDestoryWindow(GameObject windowObj, bool isClear = true)
        {
            ...
            ResourceSystem.Instance.Release(windowObj.name);
        }
